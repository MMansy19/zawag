...
export const metadata: Metadata = {
  title: "كيف نعمل - How We Work | زواج",
  description:
    "تعرف على طريقة عملنا في تيسير الزواج الحلال وفقاً للضوابط الشرعية",
};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            والتكنولوجية. هدفنا هو توفير تجربة مشابهة للطرق التقليدية التي تعتمد
            على الأسرة والمعارف، مع الاستفادة من التكنولوجيا. نسعى لخلق بيئة
            تمكنكم من البحث عن شركاء محتملين يتوافقون مع توقعاتكم، وذلك بمراعاة
            القيم الدينية.
          </p>
        </div>
        {/* Main Steps */}
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <ul className="text-sm text-gray-700 space-y-2">
                  ...
                  <li>• معلومات الاتصال الخاصة بالإخوة لا تُعرض في ملفاتهم</li>
                </ul>
              </div>
          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent>
              <p className="text-sm text-gray-700 leading-relaxed">
                إن أراد أحد الطرفين طرح أسئلة أو الاستفسار أكثر، يتم التواصل فقط
                عن طريق ولي الأمر أو القريب، ويستمر هو في التوسط في كل الحديث،
                ولا يُسمح بتواصل مباشر بين الأخ والأخت.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent>
              <p className="text-sm text-gray-700 leading-relaxed">
                ...
                موعد ومكان الرؤية الشرعية، وغالبًا تكون في بيت الأخت، وبحضور أحد
                محارمها.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent>
              <p className="text-sm text-gray-700 leading-relaxed">
                ...
                معنا لحذف ملفاتهم من الموقع، وذلك لإفساح المجال لغيرهم، وحتى لا
                تُعرض ملفاتهم بعد الارتباط.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center mt-12 p-6 bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            اختاره لكم، وأن يجعل زواجكم عونًا لكم على طاعة الله وعبادته. آمين يا
            رب العالمين.
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">تعبئة الاستمارة والتقديم</p>
            </div>
          </div>
        </div>
        {/* FAQ Section */}
        <div className="mb-16">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card className="bg-white shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-700 text-sm">
                  إذا مرّت 48 ساعة ولم تصلك رسالة، فهذا يعني أحد أمرين: إما أنك
                  لم ترسل الطلب بشكل صحيح، أو أنك أدخلت بريدًا إلكترونيًا
            ...
            <Card className="bg-white shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-700 text-sm">
                  لا يمكنك التعديل بنفسك مباشرة، لذلك نرجو الحرص من البداية على
                  دقة المعلومات. إن رغبت في تعديل أي شيء، أخبرنا ونحن نعدّله لك.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-700 text-sm">
                  بعد الموافقة المبدئية، يتم التنسيق للرؤية الشرعية عن طريق ولي
                  الأمر. كما يُنصح بالسؤال والاستفسار عن الطرف الآخر للتأكد من
                  صحة المعلومات.
                </p>
              </CardContent>
            </Card>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700">
                      بعض الأشخاص قد يسجلون بنوايا غير سليمة للسفر أو الحصول على
                      جنسية
                    </p>
                  </div>
                </div>
