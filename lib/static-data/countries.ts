...
export const countries: Country[] = [
  // Gulf Countries
  { value: "السعودية", label: "المملكة العربية السعودية", group: "الخليج العربي" },
  { value: "الإمارات", label: "دولة الإمارات العربية المتحدة", group: "الخليج العربي" },
  ...
  { value: "الجزائر", label: "الجمهورية الجزائرية الديمقراطية الشعبية", group: "شمال أفريقيا" },
  ...
  { value: "موريتانيا", label: "الجمهورية الإسلامية الموريتانية", group: "دول عربية أخرى" },
  ...
  { value: "باكستان", label: "جمهورية باكستان الإسلامية", group: "دول إسلامية" },
  { value: "بنغلاديش", label: "جمهورية بنغلاديش الشعبية", group: "دول إسلامية" },
  { value: "إندونيسيا", label: "جمهورية إندونيسيا", group: "دول إسلامية" },
  { value: "ماليزيا", label: "ماليزيا", group: "دول إسلامية" },
  { value: "أفغانستان", label: "جمهورية أفغانستان الإسلامية", group: "دول إسلامية" },
  
  // Western Countries with Muslim populations
  { value: "الولايات المتحدة", label: "الولايات المتحدة الأمريكية", group: "دول غربية" },
